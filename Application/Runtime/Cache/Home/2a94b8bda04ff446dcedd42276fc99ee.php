...
<body>
	...
	<div class="container">
		...
		<div class="img-box">
			<div class="lg-box">
			<div class="lg"><div><img src="/heavensky/Public/img/pic/01.jpg"></div></div>
			<div class="lg"><div><img src="/heavensky/Public/img/pic/02.jpg"></div></div>
			</div>
			<div class="sm-box">
			<div class="sm"><div><img src="/heavensky/Public/img/pic/03.jpg"></div></div>
			<div class="sm"><div><img src="/heavensky/Public/img/pic/04.jpg"></div></div>
			<div class="sm"><div><img src="/heavensky/Public/img/pic/05.jpg"></div></div>
			</div>
		</div>
		<div class="form">
			<div class="top">
